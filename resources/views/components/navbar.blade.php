...
<a href="{{ route('publications.my') }}" class="nav-item nav-link {{ request()->routeIs('publications.my') ? 'active' : '' }}">Publications</a>                        <div class="dropdown-menu bg-light rounded-0 m-0">
