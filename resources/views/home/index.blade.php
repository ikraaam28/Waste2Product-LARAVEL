                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-7 text-center">
                                <p class="fs-4 text-white animated zoomIn">Welcome to <strong class="text-dark">Recycle Verse</strong></p>
                                <h1 class="display-1 text-dark mb-4 animated zoomIn">Turning Waste into Value</h1>
                                <a href="{{ route('about') }}" class="btn btn-light rounded-pill py-3 px-5 animated zoomIn">Explore More</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-caption">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-7 text-center">
                                <p class="fs-4 text-white animated zoomIn">Welcome to <strong class="text-dark">Recycle Verse</strong></p>
                                <h1 class="display-1 text-dark mb-4 animated zoomIn">Eco-Friendly & Recycled Solutions</h1>
                                <a href="{{ route('about') }}" class="btn btn-light rounded-pill py-3 px-5 animated zoomIn">Explore More</a>
                            </div>
                        </div>
                    </div>
...
<div class="container-xxl py-5">
            ...
            <div class="col-lg-6">
                <div class="row g-3">
                    <div class="col-6 text-end">
                        <img class="img-fluid bg-white w-100 mb-3 wow fadeIn" data-wow-delay="0.1s" src="{{ asset('assets/img/rec3.jpg') }}" alt="">
                        <img class="img-fluid bg-white w-50 wow fadeIn" data-wow-delay="0.2s" src="{{ asset('assets/img/rec4.jpg') }}" alt="">
                    </div>
                    <div class="col-6">
                        <img class="img-fluid bg-white w-50 mb-3 wow fadeIn" data-wow-delay="0.3s" src="{{ asset('assets/img/rec5.jpg') }}" alt="">
                        <img class="img-fluid bg-white w-100 wow fadeIn" data-wow-delay="0.4s" src="{{ asset('assets/img/rec6.jpg') }}" alt="">
                    </div>
                </div>
            </div>
    ...
    <div class="section-title">
        ...
        <h1 class="display-6">Promoting Sustainable Recycling Practices</h1>
    </div>
    <div class="row g-3 mb-4">
        <div class="col-sm-4">
            <img class="img-fluid bg-white w-100" src="{{ asset('assets/img/rec1.jpg') }}" alt="Recycled products">
        </div>
        <div class="col-sm-8">
            <h5>Transforming waste into valuable products</h5>
            <p class="mb-0">We focus on turning everyday waste into eco-friendly products that benefit both people and the planet. Our commitment to sustainability drives everything we do.</p>
        </div>
    </div>
    <div class="border-top mb-4"></div>
    <div class="row g-3">
        <div class="col-sm-8">
            <h5>Encouraging eco-conscious lifestyles</h5>
            <p class="mb-0">Our mission is to educate and inspire communities to adopt sustainable habits. By using recycled products, we reduce environmental impact and promote a greener future.</p>
        </div>
        <div class="col-sm-4">
            <img class="img-fluid bg-white w-100" src="{{ asset('assets/img/rec2.jpg') }}" alt="Sustainable practices">
        </div>
    </div>
</div>
...
<div class="container-fluid product py-5 my-5">
    <div class="container py-5">
        ...
        <div class="owl-carousel product-carousel wow fadeInUp" data-wow-delay="0.5s">
            <a href="{{ route('products') }}" class="d-block product-item rounded">
    ...
    <div class="container">
        <div class="row g-5">
            ...
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                ...
                <a href="{{ route('blog') }}" class="btn btn-primary rounded-pill py-3 px-5">Read More</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row g-0">
            <div class="col-lg-6 py-5 wow fadeIn" data-wow-delay="0.1s">
                <div class="py-5">
                    ...
                    <a class="btn btn-light rounded-pill py-3 px-5" href="{{ route('store') }}">Explore More</a>
                </div>
            </div>
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="store-item position-relative text-center">
                    ...
                    <div class="store-overlay">
                        <a href="{{ route('store') }}" class="btn btn-primary rounded-pill py-2 px-4 m-2">More Detail <i class="fa fa-arrow-right ms-2"></i></a>
                        <a href="{{ route('store') }}" class="btn btn-dark rounded-pill py-2 px-4 m-2">Add to Cart <i class="fa fa-cart-plus ms-2"></i></a>
                    </div>
                </div>
            </div>
        ...
        <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.5s">
            <div class="testimonial-item p-4 p-lg-5">
                ...
                <div class="d-flex align-items-center justify-content-center">
                    <img class="img-fluid flex-shrink-0" src="{{ asset('assets/img/testimonial-1.jpg') }}" alt="">
            ...
            <div class="testimonial-item p-4 p-lg-5">
                <p class="mb-4">Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo</p>
                <div class="d-flex align-items-center justify-content-center">
                    <img class="img-fluid flex-shrink-0" src="{{ asset('assets/img/testimonial-2.jpg') }}" alt="">
                    <div class="text-start ms-3">
                        <h5>Client Name</h5>
                        <span class="text-primary">Profession</span>
                    </div>
            ...
            <div class="testimonial-item p-4 p-lg-5">
                <p class="mb-4">Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo</p>
                <div class="d-flex align-items-center justify-content-center">
                    <img class="img-fluid flex-shrink-0" src="{{ asset('assets/img/testimonial-3.jpg') }}" alt="">
                    <div class="text-start ms-3">
                        <h5>Client Name</h5>
                        <span class="text-primary">Profession</span>
                    </div>
