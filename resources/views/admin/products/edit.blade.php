    ...
    <form method="POST" action="{{ route('admin.products.update', $product) }}" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <h5 class="card-title">{{ $product->images ? 'Replace Images' : 'Add Images' }}</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <small class="text-muted">
                            ...
                            Created on {{ $product->created_at->format('Y-m-d H:i') }}
                        </small>
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    $('#images').on('change', function() {
        previewImages(this, '#images-preview', 'New main images');
    });

    $('#gallery').on('change', function() {
        previewImages(this, '#gallery-preview', 'New gallery');
    });
