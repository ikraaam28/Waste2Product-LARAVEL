                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" action="{{ route('admin.users.index') }}" class="mb-4">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="filter">Type Compte</label>
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col col-stats ms-3 ms-sm-0">
                                                <div class="numbers">
                                                    <p class="card-category">Total Utilisateurs</p>
                                ...
                                <div class="card card-stats card-round">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col col-stats ms-3 ms-sm-0">
                                                <div class="numbers">
                                                    <p class="card-category">Vérifiés</p>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if($user->email_verified_at)
                                                    <br><span class="badge badge-success mt-1">Email Vérifié</span>
                                                @else
                                                    <br><span class="badge badge-warning mt-1">Email Non Vérifié</span>
                                                @endif
                                            </td>
                                            <td>{{ $user->phone ?? '-' }}</td>
                                            <td>{{ $user->city ?? '-' }}</td>
